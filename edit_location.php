...
<body>
    <div class="container">
        <form method="POST">
            ...
            <input type="text" name="fileno" value="<?= htmlspecialchars($location['fileno']) ?>">

            <label for="shelf">Shelf:</label>
            <input type="text" name="shelf" value="<?= htmlspecialchars($location['shelf']) ?>">

            <label for="row">Row:</label>
            <input type="text" name="row" value="<?= htmlspecialchars($location['row']) ?>">

            <label for="line">Line:</label>
            <input type="text" name="line" value="<?= htmlspecialchars($location['line']) ?>">
